...
const greeting = {
  ...
  subTitle: emoji("A passionate Software Developer 🚀 having an experience of building Web and Mobile applications with JavaScript / Reactjs / Vuejs / Nodejs  and some other cool libraries and frameworks."),
  ...
  achivementsCards: [
    {
      ...
      subtitle: "Completed Certifcation from Free code camp for Responsive web Design",
    ...
    },
    {
      ...
      subtitle: "Completed Certifcation from Free code camp for JADS",
      image: require("./assets/images/image.png"),
      footerLink: [
